...
from BlackVcPlayer.modules.play import generate_cover
from BlackVcPlayer.modules.play import arq
from BlackVcPlayer.modules.play import cb_admin_check
from BlackVcPlayer.modules.play import transcode
from BlackVcPlayer.modules.play import convert_seconds
from BlackVcPlayer.modules.play import time_to_seconds
from BlackVcPlayer.modules.play import changeImageSize
from BlackVcPlayer.config import BOT_NAME as bn
from BlackVcPlayer.config import DURATION_LIMIT
from BlackVcPlayer.config import UPDATES_CHANNEL as updateschannel
from BlackVcPlayer.config import que
from BlackVcPlayer.function.admins import admins as a
from BlackVcPlayer.helpers.errors import DurationLimitError
from BlackVcPlayer.helpers.decorators import errors
from BlackVcPlayer.helpers.admins import get_administrators
from BlackVcPlayer.helpers.channelmusic import get_chat_id
from BlackVcPlayer.helpers.decorators import authorized_users_only
from BlackVcPlayer.helpers.filters import command
from BlackVcPlayer.helpers.filters import other_filters
from BlackVcPlayer.helpers.gets import get_file_name
from BlackVcPlayer.services.callsmusic import callsmusic
from BlackVcPlayer.services.callsmusic import client as USER
from BlackVcPlayer.services.converter.converter import convert
from BlackVcPlayer.services.downloaders import youtube
from BlackVcPlayer.services.queues import queues
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/2f8d070fed5956da07b8a.jpg"
...
async def jiosaavn(client: Client, message_: Message):
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @BlackVcPlayer to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
    ...
    try:
        ...
        sthumb = "https://telegra.ph/file/2f8d070fed5956da07b8a.jpg"
